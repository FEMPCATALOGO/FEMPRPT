...
| -------- | -------- | --------- | ---------- | --------------- | -------- | --------- | -------- | --------- | ---------- | 
|  Sector público. |  Inexistente  |  *[Repositorio](https://github.com/opencitydata/vocab-sector-publico-rpt)*  | *[Issues](https://github.com/opencitydata/vocab-sector-publico-rpt/issues)*  |    |    |  Instrumento técnico que tiene como objeto la ordenación del personal de acuerdo a
